...
def main():
    ...
    packages = ["base", "linux-lts", "coreutils", "procps-ng", "squashfs-tools", "leaf", "cpio","psmisc", "glibc", "bash", "sed", "grep", "gawk", "coreutils", "binutils", "findutils", "automake", "autoconf", "file", "gzip", "libtool", "m4", "groff", "patch", "texinfo", "which", "systemd", "python3", "networkmanager", "e2fsprogs"]
